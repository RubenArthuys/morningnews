...
function ScreenArticlesBySource(props) {
  ...
  useEffect(() => {
    ...
    async function loadArticleDetails() {
      ...
      const request = await fetch("https://newsapi.org/v2/top-headlines?sources="+id+"&apiKey=f5ac6b785031436a835bce1f09dbc88e")
  ...
  var saveArticles = async (article) => {
    ...
    await fetch('/wishList', { // Pour ajouter dans BDD
      method: 'POST',
...
function mapDispatchToProps(dispatch) {
  ...
  return { addToWishList : function(article) { 
